<!DOCTYPE html>     
    ...
    <!-- Catatan: Nama web dan folder tetap dipertahankan untuk mempermudah pengerjaan-->     
    <body>         
        <nav class="navbar navbar-dark bg-dark fixed-top">             
            <div class="container">                                  
                <a class="navbar-brand fw-bold" href="/pppl_a_0691">P3L</a>                 
        ...
        <div class="bg">         
            <div class="container min-vh-100 d-flex align-items-center">             
                <div class="pt-5 mt-4">                 
                    <h2 class="text-center align-middle text-white"><b class="bg-dark">Welcome</b></h2>             
                </div>             
            </div>         
        </div>         
